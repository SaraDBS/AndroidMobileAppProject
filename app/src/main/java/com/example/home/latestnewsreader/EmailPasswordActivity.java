    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnResetPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(EmailPasswordActivity.this, FirstActivity.class));
            }
        });
                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(EmailPasswordActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(EmailPasswordActivity.this, "createUserWithEmail:onComplete:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
